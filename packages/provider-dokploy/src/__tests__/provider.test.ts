...
describe("DokployProvider", () => {
	...
	it("apps.delete posts to application.delete", async () => {
		...
		expect(mockClient.post).toHaveBeenCalledWith("/api/application.delete", {
			applicationId: "app-1",
		});
	});
	...
	it("apps.deploy posts to application.deploy", async () => {
		...
		expect(mockClient.post).toHaveBeenCalledWith("/api/application.deploy", {
			applicationId: "app-1",
		});
	});
	...
	it("apps.start posts to application.start", async () => {
		...
		expect(mockClient.post).toHaveBeenCalledWith("/api/application.start", {
			applicationId: "app-1",
		});
	});
	...
	it("apps.stop posts to application.stop", async () => {
		...
		expect(mockClient.post).toHaveBeenCalledWith("/api/application.stop", {
			applicationId: "app-1",
		});
	});
	...
	it("apps.restart posts to application.redeploy", async () => {
		...
		expect(mockClient.post).toHaveBeenCalledWith("/api/application.redeploy", {
			applicationId: "app-1",
		});
	});
	...
	it("apps.logs yields log lines", async () => {
		...
		expect(mockClient.post).toHaveBeenCalledWith("/api/application.readLogs", {
			applicationId: "app-1",
			lines: 100,
		});
	});
	...
	it("deployments.cancel posts to deployment.killProcess", async () => {
		...
		expect(mockClient.post).toHaveBeenCalledWith("/api/deployment.killProcess", {
			deploymentId: "dep-1",
		});
	});
