...
describe('Dokploy normalizers', () => {
  describe('toApp', () => {
    ...
    it('handles missing domains', () => {
      const raw = {
        applicationId: 'x', name: 'x', applicationStatus: 'idle',
    ...
    it('handles domains as array of strings', () => {
      const raw = {
        applicationId: 'x', name: 'x', applicationStatus: 'running',
    ...
    it('maps done status to stopped', () => {
      const raw = {
        applicationId: 'x', name: 'x', applicationStatus: 'done',
        createdAt: '2026-01-01T00:00:00Z', updatedAt: '2026-01-01T00:00:00Z',
      }
      expect(toApp(raw).status).toBe('stopped')
    })
    ...
    it('maps error status to failed', () => {
      const raw = {
        applicationId: 'x', name: 'x', applicationStatus: 'error',
        createdAt: '2026-01-01T00:00:00Z', updatedAt: '2026-01-01T00:00:00Z',
      }
    ...
    it('maps unknown status to unknown', () => {
      const raw = {
        applicationId: 'x', name: 'x', applicationStatus: 'banana',
        createdAt: '2026-01-01T00:00:00Z', updatedAt: '2026-01-01T00:00:00Z',
      }
  ...
  describe('toServer', () => {
    ...
    it('maps inactive server to unreachable', () => {
      const raw = {
        serverId: 'srv-2', name: 'down-server', ipAddress: '10.0.0.2',
    ...
    it('maps unknown status', () => {
      const raw = {
        serverId: 'srv-3', name: 'mystery-server', ipAddress: '10.0.0.3',
      }
      const server = toServer(raw)
  ...
  describe('toDeployment', () => {
    ...
    it('maps running status', () => {
      const raw = {
        deploymentId: 'dep-2', applicationId: 'app-1', status: 'running',
        createdAt: '2026-01-01T00:00:00Z',
      }
    ...
    it('maps queued status', () => {
      const raw = {
        deploymentId: 'dep-3', applicationId: 'app-1', status: 'queued',
        createdAt: '2026-01-01T00:00:00Z',
      }
    ...
    it('maps error status to failed', () => {
      const raw = {
        deploymentId: 'dep-4', applicationId: 'app-1', status: 'error',
        createdAt: '2026-01-01T00:00:00Z',
      }
    ...
    it('maps cancelled status', () => {
      const raw = {
        deploymentId: 'dep-5', applicationId: 'app-1', status: 'cancelled',
        createdAt: '2026-01-01T00:00:00Z',
      }
  ...
  describe('toDatabase', () => {
    ...
    it('maps mysql type', () => {
      const raw = {
        databaseId: 'db-2', name: 'my-mysql', type: 'mysql',
    ...
    it('maps mariadb type', () => {
      const raw = {
        databaseId: 'db-3', name: 'my-maria', type: 'mariadb',
        applicationStatus: 'running',
      }
    ...
    it('maps mongo type', () => {
      const raw = {
        databaseId: 'db-4', name: 'my-mongo', type: 'mongo',
        applicationStatus: 'running',
      }
    ...
    it('maps redis type', () => {
      const raw = {
        databaseId: 'db-5', name: 'my-redis', type: 'redis',
        applicationStatus: 'running',
      }
    ...
    it('maps unknown type to other', () => {
      const raw = {
        databaseId: 'db-6', name: 'my-db', type: 'cockroachdb',
        applicationStatus: 'running',
      }
    ...
    it('handles missing type', () => {
      const raw = {
        databaseId: 'db-7', name: 'my-db', applicationStatus: 'idle',
      }
      expect(toDatabase(raw).engine).toBe('other')
    })
  })
